...
public class LDP {
    ...
    /**
     * <p>
     * RDFSource - A Linked Data Platform Resource (LDPR) whose state is NOT represented as RDF.
     * </p>
     */
    ...
    /**
     * <p>
     * A Linked Data Platform RDF Source (LDP-RS) that also conforms to additional patterns and conventions for managing
     * membership. * Readers should refer to the specification defining this ontology for the list of behaviors
     * associated with it.
     * </p>
     */
    ...
    /**
     * <p>
     * RDFSource - An LDPC that uses a predefined predicate to simply link to its contained resources.
     * </p>
     */
    ...
    /**
     * <p>
     * DirectContainer - An LDPC that is similar to a LDP-DC but it allows an indirection with the ability to list as
     * member a resource, * such as a URI representing a real-world object, that is different from the resource that is
     * created
     * </p>
     */
